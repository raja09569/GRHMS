...
class lazy_mofo{
	...
	public $form_text_title_add    = 'Add Payment';   // titles in the <th> of top of the edit form
	...
	public $grid_add_link    = "<a href='[script_name]action=edit&amp;[qs]' class='lm_grid_add_link'>Add a Payment</a>";  // link at displayed at the top to add a new record. [script_name] placeholder  will be populated by grid()
	...
	//added by ram
	public $grid_show_full_details_link   = "<a href='[script_name]action=showfulldetails&amp;[identity_name]=[identity_id]&amp;[qs]'>[show details]</a>";
	...
	public $pagination_text_records    = 'Room(s)';
	...
	function run(){
		...
		switch($this->get_action()){
			...
			//added by ram
			case "showfulldetails":        $this->showfulldetails();      break;
			default:              $this->index();
		}
	...
	function showfulldetails($error = ''){
		//alert("Iam in full details");
		echo $this->form($error,'showfulldetails');
	}
	function edit($error = ''){
	...
	function form($error = '',$action){
		...
		$html .= "<div class='lm_form_button_bar'>$this->form_back_button $this->form_add_button</div>";
		else if($action == 'showfulldetails')
	...
	function grid($error = ''){
		...
		$links = $grid_edit_link . ' ' . $grid_delete_link.' '.$grid_show_full_details_link;
