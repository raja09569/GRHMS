...
$lm->table = 't_guest_payment_details';
...
//gp_sno int auto_increment not null,g_sno int,room_sno int,g_first_name varchar(100), g_last_name varchar(100), 
 //      gp_actual_rent int,gp_paid_rent int,gp_due_rent int ,gp_month varchar(32),gp_paid_date date ,gp_rent_collected_by varchar(64)
...
where  coalesce(m.g_sno, '')  like :_guest_id 

order by m.gp_sno asc
";
//$lm->grid_sql_param[':_search'] = '%' . trim(@$_REQUEST['_search']) . '%';
$lm->grid_sql_param[':_guest_id'] = trim(@$_REQUEST['g_sno']);
...
//$lm->on_insert_validate['g_email'] = array('email', 'Invalid Email', 'this is optional', true); 
