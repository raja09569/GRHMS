...
<nav class="nav-bar navbar-inverse" role="navigation">
    <div id="top-menu" class="container-fluid active">
      <a class="navbar-brand" href="#">Grpg for Boys</a>
      <ul class="nav navbar-nav">
        <form id="qform" class="navbar-form pull-left" role="search">
          <!-- <input type="text" class="form-control" placeholder="Search" /> -->
         <!--  <label style="color: #999; font-size: 13px;">Welcome  : -->
         <?php //echo $_COOKIE["mysite_username"] ?> 
          <!--</label>
-->
	...
	// if (session_is_registered('login_username'))
       ...
       // }?>
		...
		jaibheemnagar, Bangalore<br />
		karnataka, 560068<br />
		Mobile No: +91-9620620234<br />
		Email: ramesh@grpg.co.in ram
		</address>
        </form>
