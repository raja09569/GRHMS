...
include('guest_view_lazy_mofo.php');
...
$lm->identity_name = 'g_sno';


// optional, make friendly names for fields
$lm->rename['room_sno'] = 'RoomNo';
$lm->rename['g_id'] = 'ID Proof';
$lm->rename['g_first_name'] = 'First Name';
...
, m.g_phone
,m.g_sno 
from  t_guest_details m 
where coalesce(m.g_first_name, '') like :_search 
or    coalesce(m.g_email, '') like :_search 
