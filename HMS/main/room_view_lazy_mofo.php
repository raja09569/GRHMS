...
class lazy_mofo{
	...
	public $form_text_title_add    = 'Add Room';   // titles in the <th> of top of the edit form
	...
	public $grid_add_link    = "<a href='[script_name]action=edit&amp;[qs]' class='lm_grid_add_link'>Add a Room</a>";  // link at displayed at the top to add a new record. [script_name] placeholder  will be populated by grid()
